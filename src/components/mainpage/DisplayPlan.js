...
// import { Plan } from "../ProfilePage/Plan"

// export const DisplayPlan = () => {

//     //TO DO: add the state where the display will be pulling the plan for display. This will come from module where we randomly generate a three-part plan.
